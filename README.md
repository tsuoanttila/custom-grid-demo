...
Customised version of the Vaadin Grid that has space select based multiselection without a 
selection column, customized editor event handling that opens the editor with click and/or 
enter, move the active editor with ctrl/command + arrows. It also uses a custom Checkbox renderer
that provides instant value update + opens the editor.
